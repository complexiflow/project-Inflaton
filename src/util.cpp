...
int nAnonymizeinflatonAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\inflaton
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\inflaton
    // Mac: ~/Library/Application Support/inflaton
    // Unix: ~/.inflaton
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "inflaton";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "inflaton.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "inflatond.pid"));
